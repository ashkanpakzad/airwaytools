...
[airway_number, classification] = LobeClassifier('N1_raw_image_lumen_seg.nii', 'N1_lobe_seg.nii.gz');
...
for j = 1:length(airway_number)
    ...
    N1_cleaned_data(j).lumen_log_taper_rate = log_taper_rate_lumen;
    N1_cleaned_data(j).wall_log_taper_rate = log_taper_rate_wall;
